...
// A separate root layout (Next's "multiple root layouts" pattern, via
// the (site) route group next to this one) — its own <html>/<body>, no
// marketplace Header/Footer or client Providers, so the admin panel
// never inherits chrome meant for admin.lotclub.in's sibling, the main
// site at lotclub.in.
